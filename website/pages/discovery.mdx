...
|--------------|---------------|-------------|----------------------------------------------------------|----------|
| Isolated | Summary       | Automatic      | [Discovery API](https://federated-research.github.io/discovery-api/)      | [Discovery API](https://federated-research.github.io/discovery-api/)          |
