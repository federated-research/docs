...
The **Security Plane** focusses on governance security, it manages ingress and egress control within a federated Trusted Research Environment (TRE). 
...
- **Policy Compliance**: Checking of queries against security policies
