...
* At least one TRE
* OMOP database connected to each TRE (the default demo expects an OMOP database)
...
## Setup
1. Clone the repository (https://github.com/Health-Informatics-UoN/TRE-FX-Analytics)
