...
This project requires two specific **.NET SDK versions : 7.0 and 8.0** to be installed.


<Callout type="warning">
    **Before proceeding to the next steps, make sure you have both SDK versions are installed on your machine. If you don’t have SDK, then install them as follows**.
</Callout>

**You can install them in one of the following ways:**

#### <u> Option 1: Install via .NET Website </u>

- **.NET 7 SDK:** https://dotnet.microsoft.com/en-us/download/dotnet/7.0
- **.NET 8 SDK:** https://dotnet.microsoft.com/en-us/download/dotnet/8.0

Download and run the installers for your operating system (macOS, Windows, or Linux).

#### <u> Option 2: Install via Curl Command </u>

Microsoft provides an installation script that allows you to install .NET SDKs using curl.

**Install .NET 7 SDK** 
```bash copy
curl -L https://dot.net/v1/dotnet-install.sh | bash -s -- --channel 7.0
```

**Install .NET 8 SDK** 
```bash copy
curl -L https://dot.net/v1/dotnet-install.sh | bash -s -- --channel 8.0
```
...
To begin development, you need to clone the DARE-Control and 5S-TES-Deployment repositories onto your local machine. You can do this directly through your IDE.



#### <u> Repo Cloning via JetBrains Rider (macOS) </u>

- **Open Rider**
- From the welcome screen, select **“Get from Version Control”**
- In the **URL** field, paste the repository link:
```bash copy
https://github.com/SwanseaUniversityMedical/DARE-Control.git
```
```bash copy
https://github.com/SwanseaUniversityMedical/5S-TES-deployment.git
```
- Choose a **local directory** where the project should be stored.
- Click **Clone**.
- Rider will automatically load and index the project.


#### <u> Optional: Command-Line Clone </u>

If you prefer using Git directly, run the command in the terminal:

```bash copy

git clone https://github.com/SwanseaUniversityMedical/DARE-Control.git
```
