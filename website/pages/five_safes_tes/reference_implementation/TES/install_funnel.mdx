...
[Funnel's documentation](https://ohsu-comp-bio.github.io/funnel/docs/) offers configuration details in the relevant pages for each feature area.
...
For All In One quickstart, by default, Funnel Web Dashboard can be accessed at [localhost:8000](http://localhost:8000).
