...
- [Funnel](https://github.com/ohsu-comp-bio/funnel) is chosen as the TES executor for the All-In-One quickstart and it needs to be installed beforehand. Instructions can be found [here](/five_safes_tes/reference_implementation/TES/install_funnel).
...
The Hello World submission is a simple submission that will be used to demo the DemoStack stack.
