...
<Callout type="info">
  The quickstart is expected to take approximately 60 minutes to complete.
</Callout>
...
* captures the container output in a file and saves it to the `/outputs` bucket in MinIO ("outputs" section)
