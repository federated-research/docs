...
To make sure that the project has been approved and [Submission Layer](/five_safes_tes/reference_implementation/core_components#submission-layer) is in sync with [TRE Agent](/five_safes_tes/reference_implementation/core_components#tre-api), log into the Submission Layer at [localhost:7220](http://localhost:7220), using the same credentials as you used for the TRE Agent. Select the project, and navigate to the **_TREs_** section. You should see **_Approved_** status for the TRE.
