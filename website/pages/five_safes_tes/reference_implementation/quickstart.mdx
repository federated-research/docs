...
<Callout type="info">
  ...
  Once the Docker Compose stack has started successfully, if the seeded project and TRE do not appear yet, please allow approximately 2 minutes for the syncing process.
