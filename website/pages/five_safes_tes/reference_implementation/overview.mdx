...
Five Safes TES is designed to be deployed in a federated network of TREs. The TREs are connected to Five Safes TES through a secure network connection and environment.

Below is a diagram that illustrates a simple demonstration of the how network connections are established between the Five Safes TES components.

<Callout>
  This diagram is NOT a recommended network configuration for the Five Safes TES in production.
</Callout>

<figure style={{ textAlign: 'center', paddingTop: '20px' }}>
  <img
    src="/images/Five Safes TES - Networking.png"
    alt="Five Safe TES Networking"
    width="100%"
    style={{ display: "block", margin: "0 auto" }}
  />
    <figcaption style={{ fontStyle: 'italic', fontSize: '0.7em', marginTop: '8px' }}>
        Figure 3: Simple example of the network connections between the Five Safes TES components.
    </figcaption>
</figure>
