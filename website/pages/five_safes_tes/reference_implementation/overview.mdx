...
The Five Safes TES is designed to be deployed in a federated network of TREs. The TREs are connected to the Five Safes TES through a secure network connection and environment.

Below is a diagram that illustrates an example of the how network connections are established between the Five Safes TES components and which ports on the Virtual Machines should be opened for the inbound/outbound connections.
...
<figure style={{ textAlign: 'center', paddingTop: '20px' }}>
  ...
  />
    <figcaption style={{ fontStyle: 'italic', fontSize: '0.7em', marginTop: '8px' }}>
        Figure 3: The network connections between the Five Safes TES components.
    </figcaption>
</figure>
