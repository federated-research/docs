...
<figure>
  <Diagram
    alt_image="/images/likec4/deployments/prod.png"
    alt_text="Example production deployment configuration for a multi-component service using a reverse proxy."
    viewId="prod"
  />
  <figcaption
    style={{ fontStyle: "italic", fontSize: "0.7em", marginTop: "8px" }}
  >
    Figure 1: Example production deployment configuration. Click for
    interactive mode.
  </figcaption>
</figure>