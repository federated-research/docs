...
To deploy an instance of the [TRE Agent](/first_demo/stackinfo#tre-agent-tre-layer) & [Egress](/first_demo/stackinfo#egress-tre-layer):

<Steps>
### Go to the TRE Layer directory
Within the DARE-TREFX-Environment1 directory the TRE Layer docker-compose and configuration files are in the `TRE-Keycloak` directory:
