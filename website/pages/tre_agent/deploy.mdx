...
<Table>
  ...
  <tbody>
    ...
    <Tr>
      <Td>`PGLOGIN`</Td>
      <Td>
        The admin username for the PostgreSQL database used by the TRE Agent.
      </Td>
    </Tr>
    <Tr>
      <Td>`PGPASSWORD`</Td>
      <Td>
        The admin password for the PostgreSQL database used by the TRE Agent.
      </Td>
    </Tr>
    <Tr>
      <Td>`TRE_DATA_SERVER`</Td>
      <Td>
        The hostname of the PostgreSQL database server used for TRE data. Used
        for the TRE Agent to create temporary credentials against a postgres
        database.
      </Td>
    </Tr>
    <Tr>
      <Td>`TRE_DATA_PORT`</Td>
      <Td>
        The port number of the PostgreSQL database server used for TRE data.
      </Td>
    </Tr>
    <Tr>
      <Td>`TRE_DATA_DATABASE`</Td>
      <Td>The name of the PostgreSQL database used for TRE data.</Td>
    </Tr>
    <Tr>
      <Td>`TRE_DATA_USER`</Td>
      <Td>The username for the PostgreSQL database used for TRE data.</Td>
    </Tr>
    <Tr>
      <Td>`TRE_DATA_PASSWORD`</Td>
      <Td>The password for the PostgreSQL database used for TRE data.</Td>
    </Tr>
    <Tr>
      <Td>`DemoMode`</Td>
      <Td>
    ...
    <Tr>
      <Td>`MinioTreUrl`</Td>
      <Td>
        The URL for the TRE Minio server, for internal access within Docker
        network. For example, `http://minio:9000`.
      </Td>
    </Tr>
    <Tr>
    ...
    <Tr>
      ...
      <Td>The bundle version of Camunda to deploy.</Td>
    </Tr>
    <Tr>
    ...
    <Tr>
      <Td>`useproxy`</Td>
      <Td>Set to `true` to use a proxy, otherwise set to `false`.</Td>
    </Tr>
    <Tr>
      <Td>`proxyurl`</Td>
      <Td>
        The proxy URL if using a proxy. For example,
    ...
    <Tr>
      <Td>`sslcookies`</Td>
      <Td>
        If this is set to `true`, the TRE Agent will use secure SSL cookies.
        Default is `false` to prevent issues with Keycloak.
      </Td>
    </Tr>
    <Tr>
      <Td>`httpsRedirect`</Td>
    ...
    <Tr>
      ...
      <Td>
        The Submission API address URL. For example, `http://localhost:5034`.
      </Td>
    </Tr>
    <Tr>
      <Td>`submissionMinioUrl`</Td>
      <Td>
        Point to submission minio. For example, `http://minioSubmission:9000`.
      </Td>
    </Tr>
    <Tr>
    ...
    <Tr>
      ...
      <Td>
        ...
        `http://keycloak:8080/realms/Data-Egress`.
      </Td>
    </Tr>
    <Tr>
    ...
    <Tr>
      ...
      <Td>
        The OpenID secret for the Egress Keycloak client `Data-Egress-API`.
      </Td>
    </Tr>
    <Tr>
    ...
    <Tr>
      ...
      <Td>
        The OpenID metadata address URL for the Submission Keycloak realm. For
        example,
        `http://keycloak:8080/realms/Dare-Control/.well-known/openid-configuration`.
      </Td>
    </Tr>
    ...
    <Tr>
      ...
      <Td>
        ...
        example, `http://localhost:8989/Account/LoginAfterTokenExpired`.
      </Td>
    </Tr>
    <Tr>
    ...
    <Tr>
      ...
      <Td>
        ...
        `http://localhost:8888/Account/LoginAfterTokenExpired`.
      </Td>
    </Tr>
    <Tr>
    ...
    <Tr>
      ...
      <Td>The OpenID secret for the TRE UI Keycloak client `Dare-TRE-UI`.</Td>
    </Tr>
    <Tr>
      <Td>`TreKeyCloakBaseRealmAddress`</Td>
      <Td>
        This is the realm address for the TRE's Keycloak server. For example,
        `http://keycloak:8080/realms/Dare-TRE`.
      </Td>
    </Tr>
    <Tr>
    ...
    <Tr>
      ...
      <Td>
        The OpenID metadata address URL for the TRE Keycloak realm. For example,
        `http://keycloak:8080/realms/Dare-TRE/.well-known/openid-configuration`.
      </Td>
    </Tr>
    <Tr>
    ...
    <Tr>
      ...
      <Td>The OpenID secret for the TRE API Keycloak client `Dare-TRE-API`.</Td>
    </Tr>
    <Tr>
