...
<Callout type="info">
  ...
  `5S-TES-deployment` repository will then serve as a reference files for your
  own deployment.
</Callout>
...
At the directory where you store the [four necessary components](#prepare-the-necessary-files), run the following command to start the TRE Agent and Data Egress:
