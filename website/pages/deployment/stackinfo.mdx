...
## TRE Management Website (TRE Agent Layer)
...
Once the task is finished executing the TRE Agent sends the results to the Egress Layer.
...
The Egress Layer handles egress requests. Once a task is finished executing the results are then waiting for approval in the Egress layer.
