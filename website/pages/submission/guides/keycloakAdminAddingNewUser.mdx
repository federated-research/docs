...
<Steps>
### Login to Keycloak
Login to Keycloak server of Submission Layer as an admin user.

<Callout type="info">
If you are using the DemoStack or the default local Keycloak server, the admin user credentials are:
```yaml copy
Username: admin
Password: admin
```
and the URL of the Keycloak server is: [http://localhost:8085](http://localhost:8085)
...
<img src="/images/KeyCloak_DareControlUserPage.png" width="80%"></img>
...
<img src="/images/KeyCloak_DareControlCreateUser.png" width="80%"></img>
...
<img src="/images/KeyCloak_DareControlCreateUserSelectGroups.png" width="80%"></img>
...
<img src="/images/KeyCloak_ChangeUserDetails.png" width="80%"></img>

<Callout>
For the demonstration purpose - 'DemoStack', use these configurations:
