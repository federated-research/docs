...
- Follow this [guide](/submission/guides/keycloakAdminAddingNewUser) to create a user with the `dare-tre-admin` role. Use the username and password of this user for steps below
...
<img src="/images/createTre.png" width="80%"></img>

<Callout type="info">If you are using the DemoStack, the user in step 2 already exists and its username is: `accessfromtretosubmission`  </Callout>

### Create a Project with the TRE
- Create a Project, add TREs and users to the Project following this [guide](/submission/guides/submissionManagerSetupNewProject).
</Steps>
...
<Callout type="info">
If you are using the DemoStack, the credentials are:
```yaml copy
