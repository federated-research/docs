...
| **Minio**          | So that researchers can upload and download Submission data (inputs or outputs)             |
| **Submission GUI** | So that users can log into and interact with the Submission Layer                           |
| **Submission API** | _Optional_. So that researchers can make submissions, and check their status via a REST API |
