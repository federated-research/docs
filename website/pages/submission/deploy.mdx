...
Within the 5S-TES-deployment directory, the Submission Layer docker compose and configuration files are in
the `DeploymentStack/Submission` [directory](https://github.com/SwanseaUniversityMedical/5S-TES-deployment/tree/main/DeploymentStack/Submission):

```bash copy
cd DeploymentStack/Submission
```
