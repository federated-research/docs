...
In Trellis, a **Plane** is a logical layer of functions and responsibilities within a federated TRE, grouping related capabilities so they can be described and secured consistently. 
...
A Weave can reference Helm charts, configuration files, and operational metadata, enabling reproducible deployment of federation capabilities.
...
Different Weaves will enable different capability and software across a federated TRE. 
