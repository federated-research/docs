...
- Agents at remote TREs automatically collect and run approved analyses.
...
|--------------|---------------|-------------|----------------------------------------------------------|----------|
| Decomposable | Summary       | Manual      | Initiate: Submission Layer and Process: TES-K or Funnel| |----------|
