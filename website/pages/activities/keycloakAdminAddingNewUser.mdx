...
<img src="/images/KeyCloak_LoginPage.png" width="500"></img>

The Keycloak admin needs to log onto the Keycloak server.
In the 'AllInOne' stack this is at `localhost:8085`,
