...
Through federated research, new research data infrastructure can be deployed that can support research health research across various data sources. Importantly, these solutions and approaches can be applied to domains beyond health and will enable more complex questions to be asked on greater and more diverse populations. To meet this, the objectives across the Federated Research programme are:
