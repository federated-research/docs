...
This is the entry point for a researcher. Approved researchers can submit tasks to a Project using the API or by interacting with the UI.

The code for Submission is open source, and can be found on [Github](https://github.com/SwanseaUniversityMedical/DARE-Control).

## Core Functionality

- Provides an API and UI for researchers to submit tasks
