...
Relay coordinates Cohort Discovery queries across a federated network of subnodes. It can issue queries to any compatible upstream Task API and aggregate the returned results into a single response.
