...
A **Weave** is a combination of a platform and computational pattern. 

instantiation of Patterns that enables a consistent description of the capabilities for an approach to federation.
