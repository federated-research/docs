...
The analyses that can be run within the boundary of the TRE are almost unlimited and constrained by the compute and permissions from the TRE. Disclosure control can be applied which will limit the results that can analysed together. 
